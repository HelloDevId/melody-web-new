...
<div class="container">
    <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
        <a class="btn btn-dark btn-sm mb-4" href="/"><i class="fa fa-arrow-left"></i> Back</a>
    </div>
</div>
                        ...
                        <div class="slick3 gallery-lb">
                            <div class="item-slick3" data-thumb="{{  asset('foto/product/' . $product['image'])  }}">
                                <div class="wrap-pic-w pos-relative">
                                    ...
                                    <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{  asset('foto/product/' . $product['image'])  }}">
