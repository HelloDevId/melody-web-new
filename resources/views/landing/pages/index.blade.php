...
@section('content')
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="/detail-product/{{ $data->id }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								View
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/detail-product/{{ $data->id }}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									{{ $data->name }}
								</a>
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form>
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							<img class="how-pos4 pointer-none" src="{{ asset('landing/images/icons/icon-email.png') }}" alt="ICON">
						</div>
	...
	<!-- Map -->
	<div class="map">
		<div class="size-303" id="google_map" data-map-x="40.691446" data-map-y="-73.886787" data-pin="{{ asset('landing/images/icons/pin.png') }}" data-scrollwhell="0" data-draggable="1" data-zoom="11"></div>
	</div>
